...
$(document).on("click", ".show", function () {
    ...
    $(".truncate").html(fullReviews[position] + "<span class='hide' data-hide='" + position + "'>[Read Less]</span>");//used the "Hide" generated last, with data-count of 9. swap to attatch both show and hide and just toggle show/hide
...
$(document).on("click", ".hide", function () {
    ...
    $(".truncate").html(fullReviews[position].substring(0, 500) + "<span class='show' data-show='" + position + "'>[Read More]</span>");
});
